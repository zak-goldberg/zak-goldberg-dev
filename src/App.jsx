...
import { Laptop, Medal, Headphones } from "lucide-react";
...
function App() {
  return (
    <div>
      ...
      <section className="container mx-auto pt-20 pb-2 px-4">
        <div className = "flex flex-col justify-evenly border rounded md:flex-row md:space-x-4 md:space-y-0">
            <div className="flex flex-col justify-center">
              <h4 className="text-5xl font-bold mb-2 text-white">Welcome 👋🏼</h4>
              <h4 className="text-4xl text-white">I am <span className="font-semibold">Zak Goldberg</span></h4>
            </div>
            <div className="w-1/2">
              <img className="py-5 w-1/2 h-auto object-contain mx-auto" src="/zak_addie.jpg" />
            </div>
        </div>
      </section>
      <section id="Links" className="container mx-auto px-4 py-2">
        <div className = "py-2 flex justify-evenly border rounded text-white">
          <svg className="max-w-12 h-auto fill-white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>GitHub</title>
          ...
          <svg className="max-w-12 h-auto fill-white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>LinkedIn</title>
            <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
          </svg>
          <svg className="max-w-12 h-auto fill-white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Strava</title>
            <path d="M15.387 17.944l-2.089-4.116h-3.065L15.387 24l5.15-10.172h-3.066m-7.008-5.599l2.836 5.598h4.172L10.463 0l-7 13.828h4.169"/>
          </svg>
          <svg className="max-w-12 h-auto fill-white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Spotify</title>
